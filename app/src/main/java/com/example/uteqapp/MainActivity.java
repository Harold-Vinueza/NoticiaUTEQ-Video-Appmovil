...
import com.example.uteqapp.WebServices.Asynchtask;
import com.example.uteqapp.WebServices.WebService;
...
public class MainActivity extends AppCompatActivity implements Asynchtask {
    ...
    public void processFinish(String result) throws JSONException {
        ...
        ArrayList<Noticia> lstNoticias = Noticia.JsonObjectsBuild(JSONLista);
        Adaptador adapatorNoticia = new Adaptador(  this, lstNoticias);
